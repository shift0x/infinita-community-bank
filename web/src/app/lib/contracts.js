...
export const lendingVaultABI = [
    {
      "inputs": [
        {
          "internalType": "contract IBankVault",
          "name": "_vault",
          "type": "address"
        },
        {
    ...
    {
      "inputs": [],
      "name": "InvalidLoanStatusForOperation",
      "type": "error"
    },
    {
      "inputs": [],
      "name": "InvalidPaymentAmountForLoanBalance",
      "type": "error"
    },
    {
      "inputs": [],
      ...
      "outputs": [
        {
          "components": [
            ...
            {
              "internalType": "uint256",
              "name": "principalAmountPerDollarOwed",
              "type": "uint256"
            },
            {
...
export const bankContract = {
    ...
    {
      "inputs": [],
      "name": "InsufficentBankReserves",
      "type": "error"
    },
    {
      "inputs": [],
      "name": "InsufficentStakedBalanceForWithdrawl",
      "type": "error"
    },
    {
      "inputs": [],
      "name": "InsufficentTokenBalanceForStaking",
      "type": "error"
    },
    {
      "inputs": [],
